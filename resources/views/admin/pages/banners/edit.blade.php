            ...
            <form method="post" action="{{ route('banner.update', $banner->id) }}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                  ...
                  <input type="text" class="form-control my-colorpicker1" placeholder="Name" name="title" value="{{ old('title',$banner->title) }}">
                </div> 
                <label for="toggleCheckbox">Show Youtube Video</label>
                <input type="checkbox" id="toggleCheckbox" @if(!$banner->type =='1') checked @endif>
                ...
                <div id="videoInput" style="display: none;">
                    ...
                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                      ...
                      <input id="videoUrl" type="text" class="form-control my-colorpicker1" placeholder="Link" name="link" value="{{ old('link',$banner->video) }}">
                    </div>
                </div>
